...
const NAV_ITEMS = [
  ...
  { to: '/produtos', label: 'Estoque', icon: ProductIcon },
  { to: '/revendedoras', label: 'Revendedoras', icon: PeopleIcon },
  { to: '/admin/produtos', label: 'Gerenciar Produtos', icon: SettingsIcon, adminOnly: true },
  { to: '/admin/estoque', label: 'Estoque & Garantia', icon: BoxIcon, adminOnly: true },
