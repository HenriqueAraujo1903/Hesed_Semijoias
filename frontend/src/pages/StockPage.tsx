...
export default function StockPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-stone-800">Estoque &amp; Garantia</h1>
        <p className="mt-1 text-sm text-stone-500">Reposição, ajustes de estoque e controle de garantia.</p>
      </div>
